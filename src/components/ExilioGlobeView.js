...
const ExilioGlobeView = ({ isOpen, onClose }) => {
    ...
    return (_jsx(AnimatePresence, { children: isOpen && (_jsx(motion.div, { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/70", initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, onClick: onClose, children: _jsxs(motion.div, { className: "relative bg-gray-500/30 backdrop-blur-xl rounded-lg shadow-xl overflow-hidden max-w-3xl w-full mx-4 max-h-[90vh] border border-white/10", initial: { scale: 0.9, y: 10 }, animate: { scale: 1, y: 0 }, exit: { scale: 0.9, y: 10 }, onClick: e => e.stopPropagation(), children: [_jsxs("div", { className: "flex items-center justify-between p-4 border-b border-gray-700/50", children: [_jsx("h2", { className: "text-xl font-medium text-white", children: "Lugares de Memoria en el Exilio" }), _jsx("button", { onClick: onClose, className: "text-gray-400 hover:text-white transition-colors bg-white/5 hover:bg-white/10 rounded-full p-1", children: _jsx(X, { size: 20 }) })] }), _jsx("div", { className: "p-4 bg-gray-500/20", children: _jsx("p", { className: "text-gray-300 mb-4 text-sm", children: "La memoria del conflicto colombiano tambi\u00E9n se construye desde lugares fuera del territorio nacional. Estos espacios creados por comunidades en el exilio contribuyen a la preservaci\u00F3n de la memoria hist\u00F3rica y la b\u00FAsqueda de verdad y reconciliaci\u00F3n." }) }), _jsx("div", { ref: mapContainerRef, className: "w-full h-[400px]" }), _jsx("div", { className: "p-4 border-t border-gray-700/50 bg-gray-500/20", children: _jsx("p", { className: "text-xs text-gray-300", children: "Este mapa muestra ubicaciones representativas donde comunidades colombianas en el exilio han creado espacios de memoria." }) })] }) })) }));
};
